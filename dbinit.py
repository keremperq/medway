...
INIT_STATEMENTS = [
    ...
    CREATE TABLE IF NOT EXISTS TRANSACTION_PRODUCT (
     ...
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('Strix Helios Tempered Glass RGB USB 3.1 Mid Tower Case', 'ASUS', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('PowerBoost RGB Gaming Case', 'POWER BOOST', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('Hyper 212 Spectrum Rainbow LED', 'COOLER MASTER', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('ASUS ROG RYUO 240 RGB', 'ASUS', '',2)",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('Corsair Void Elite RGB 7.1 Surround Black Gaming', 'CORSAIR', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('Razer Hammerhead True Wireless Headset', 'RAZER', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('XPG Summoner Cherry Mx Blue RGB Gaming Keyboard', 'XPG', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('Logitech G G512 GX Brown RGB Gaming Keyboard', 'LOGITECH', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('Alienware AW2521HF 240Hz FHD IPS Freesync G-sync Gaming Monitor', 'ALIENWARE', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('ASUS 27inch VG278QF 165Hz 0.5ms DVI-D Gaming Monitor', 'ASUS', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('ASUS PRIME B550M-A (WI-FI) 4600MHz(OC) DDR4 Motherboard', 'ASUS', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('GIGABYTE B450M S2H V2 3600MHz(OC) DDR4 Socket AM4', 'GIGABYTE', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('ASUS ROG GLADIUS II ORIGIN MS For Bundle Aura Sync Fps Gaming Mouse', 'ASUS', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('Steelseries Sensei Ten RGB Gaming Mouse', 'STEELSERIES', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('SHARKOON SHP650 V2 650W 80+ 120mm PSU', 'SHARKOON', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('SHARKOON WPM GOLD ZERO 650W 80+ Gold Moduler 140mm PSU', 'SHARKOON', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('INTEL Core i3 10100F 3.60GHz 1200 14nm', 'INTEL', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('AMD RYZEN 5 5600X 3.7GHz 32MB AM4 7nm Processor', 'AMD', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('XPG 8GB Gammix D30 Red 3000MHz CL16 DDR4 Single Kit Ram', 'XPG', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('HYPERX 16GB Fury RGB 3200MHz CL16 DDR4 Single Kit Ram', 'HYPERX', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('GIGABYTE GeForce RTX 3090 AORUS xtreme 24GB GDDR6X', 'GIGABYTE', '')",
     "INSERT INTO EQUIPMENT (EQ_NAME, EQ_BRAND, EQ_IMAGE) VALUES ('SAPPHIRE RX 550 PULSE OC 4GB GDDR5 128Bit DX12', 'SAPPHIRE', '')",
     "INSERT INTO EQ_CASE (CASE_TYPE, HAS_AUDIO, IS_TRANSPARENT, HAS_PSU, EQ_ID, CAT_ID) VALUES ('ATX Mid Tower','Yes','Yes',1,1)",
     "INSERT INTO EQ_CASE (CASE_TYPE, HAS_AUDIO, IS_TRANSPARENT, HAS_PSU, EQ_ID, CAT_ID) VALUES ('ATX Mid Tower','Yes','No',2,1)",
     "INSERT INTO EQ_COOLER (COOLER_TYPE, COOLER_SIZE, LED_COLOR, EQ_ID, CAT_ID) VALUES ('Air Cooler','120mm','Multi Color',3,2)",
     "INSERT INTO EQ_COOLER (COOLER_TYPE, COOLER_SIZE, LED_COLOR, EQ_ID, CAT_ID) VALUES ('Liquid Cooling','120mm','Multi Color',4,2)",
     "INSERT INTO EQ_HEADSET (USAGE_AREA, HEADSET_TYPE, HAS_MIC, EQ_ID, CAT_ID) VALUES ('Gaming','On-ear','Yes',5,3)",
     "INSERT INTO EQ_HEADSET (USAGE_AREA, HEADSET_TYPE, HAS_MIC, EQ_ID, CAT_ID) VALUES ('Music & Entertainment','In-ear','Yes',6,3)",
     "INSERT INTO EQ_KEYBOARD (KEYBOARD_TYPE, KEY_SEQUENCE, IS_MECHANIC, IS_RGB, EQ_ID, CAT_ID) VALUES ('Wired','Turkish Q','Yes', 'Yes',7,4)",
     "INSERT INTO EQ_KEYBOARD (KEYBOARD_TYPE, KEY_SEQUENCE, IS_MECHANIC, IS_RGB, EQ_ID, CAT_ID) VALUES ('Wireless','Turkish Q','No', 'Yes',8,4)",
     "INSERT INTO EQ_MONITOR (SCREEN_SIZE, RESOLUTION, REFRESH_RATE, EQ_ID, CAT_ID) VALUES ('24.5 inch','1920 x 1080','240 Hz',9,5)",
     "INSERT INTO EQ_MONITOR (SCREEN_SIZE, RESOLUTION, REFRESH_RATE, EQ_ID, CAT_ID) VALUES ('27 inch','1920 x 1080','165 Hz',10,5)",
     "INSERT INTO EQ_MOTHERBOARD (RAM_TYPE, MAX_RAM, RAM_SLOT_NUMBER, SOCKET_TYPE, RAM_FRE_SPEED, EQ_ID, CAT_ID) VALUES ('DDR4','128 GB',4,'AM4', '4600 MHz, 4400 MHz',11,6)",
     "INSERT INTO EQ_MOTHERBOARD (RAM_TYPE, MAX_RAM, RAM_SLOT_NUMBER, SOCKET_TYPE, RAM_FRE_SPEED, EQ_ID, CAT_ID) VALUES ('DDR4','32 GB',2,'AM4', '3600 MHz, 3466 MHz',12,6)",
     "INSERT INTO EQ_MOUSE (MOUSE_TYPE, DPI, BUTTONS, EQ_ID, CAT_ID) VALUES ('Wired','12000 Dpi',6,13,7)",
     "INSERT INTO EQ_MOUSE (MOUSE_TYPE, DPI, BUTTONS, EQ_ID, CAT_ID) VALUES ('Wired','18000 Dpi',8,14,7)",
     "INSERT INTO EQ_POWERSUPPLY (POWER_W, POWER_TYPE, SATA_CONNECTION, EQ_ID, CAT_ID) VALUES ('650W','ATX',4,15,8)",
     "INSERT INTO EQ_POWERSUPPLY (POWER_W, POWER_TYPE, SATA_CONNECTION, EQ_ID, CAT_ID) VALUES ('650W','ATX',9,16,8)",
     "INSERT INTO EQ_PROCESSOR (MODEL, FRE_SPEED, CORE_NUMBER, EQ_ID, CAT_ID) VALUES ('Core i3','3.6 GHz',4,17,9)",
     "INSERT INTO EQ_PROCESSOR (MODEL, FRE_SPEED, CORE_NUMBER, EQ_ID, CAT_ID) VALUES ('Ryzen 5','3.7 GHz',6,18,9)",
     "INSERT INTO EQ_RAM (RAM_TYPE, CAPACITY, FRE_SPEED, EQ_ID, CAT_ID) VALUES ('DDR4','8GB','3000 MHz',19,10)",
     "INSERT INTO EQ_RAM (RAM_TYPE, CAPACITY, FRE_SPEED, EQ_ID, CAT_ID) VALUES ('DDR4','16GB','3200 MHz',20,10)",
     "INSERT INTO EQ_VIDEOCARD (MEMORY_SIZE, CORE_SPEED, GPU_MODEL, MANUFACTURER, EQ_ID, CAT_ID) VALUES ('24GB','1695 MHz','GeForce RTX 3090', 'NVIDIA',21,11)",
     "INSERT INTO EQ_VIDEOCARD (MEMORY_SIZE, CORE_SPEED, GPU_MODEL, MANUFACTURER, EQ_ID, CAT_ID) VALUES ('4GB','1206 MHz','Radeon RX 550', 'AMD',22,11)",
