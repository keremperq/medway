...
INIT_STATEMENTS = [
    ...
    CREATE TABLE IF NOT EXISTS TRANSACTION_PRODUCT (
     ...
     "INSERT INTO PERSON (PERSON_NAME, SURNAME) VALUES ('Kerem', 'GUCLU')",
     "INSERT INTO CUSTOMER (PERSON_ID, USERNAME, EMAIL, PASS_HASH, PHONE, IS_ACTIVE) VALUES (1, 'admin', 'email1@itu.edu.tr', '$pbkdf2-sha256$29000$F.Kc855TKoWQ8n5PqXUO4Q$zmHEwNkNPTjaCvpSl4eDDgb8OWQ9J16nqeysIFIzSpM', '2325421326', TRUE)",
